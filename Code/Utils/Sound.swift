...
//
//  Original source: https://github.com/InerziaSoft/ISSoundAdditions/blob/master/Sources/ISSoundAdditions/Sound.swift
//  Original source: https://github.com/InerziaSoft/ISSoundAdditions/blob/master/Sources/ISSoundAdditions/SoundOutputManager.swift
//
//  License: MIT
//
...
public enum Sound {
    ...
    public static func volume() -> Float? {
        do {
            ...
            log(tag: "Volume", "Error reading volume: \(error)")
        }
    ...
    public static func setVolume(_ volume: Float) {
        ...
        do {
            ...
            log(tag: "Volume", "Error setting volume: \(error)")
        }
    }
    ...
    public static func isMuted() -> Bool? {
        do {
            ...
            log(tag: "Volume", "Error reading mute: \(error)")
        }

        return nil
    }

    public static func mute(_ isMuted: Bool) {
        do {
            try Sound.output.mute(isMuted)
        } catch {
            log(tag: "Volume", "Error setting mute: \(error)")
        }
    }
}
    ...
    public final class SoundOutputManager {
        ...
        public func retrieveDefaultOutputDevice() throws -> AudioDeviceID? {
            ...
            let error = AudioObjectGetPropertyData(
                AudioObjectID(kAudioObjectSystemObject), &address, 0, nil, &size, &result)
        ...
        public func setVolume(_ newValue: Float) throws {
            ...
            let isSettableError = AudioObjectIsPropertySettable(
                deviceID, &address, &canChangeVolume)
            ...
            let error = AudioObjectSetPropertyData(
                deviceID, &address, 0, nil, size, &normalizedValue)
